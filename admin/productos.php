<?php
    ...
    $resultado = $conexion ->query("select productos.*, categorias.nombre as catego from productos inner join categorias on productos.id_categoria = categorias.id order by id ASC")or die($conexion->error);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <i class="fas fa-plus"></i> Insertar Producto
</button>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <tbody>
          ...
          ?>
            <tr>
              <td><?php echo $f['id']; ?></td>
              <td>
                <img src="../images/<?php echo $f['imagen']; ?>" width="40px" height="40px" alt="" class="img-fluid">
                <?php echo $f['nombre']; ?>
              </td>
