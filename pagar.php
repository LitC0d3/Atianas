                ...
                <div class="row">
                    ...
                    <div class="col-md-5 ml-auto">
                        ...
                        <form action="http://localhost/Atianas-1/thankyou.php?id_venta=.$_GET['id_venta']." &metodo=mercadopago" method="POST">
                            <script src="https://www.mercadopago.com.pe/integrations/v1/web-payment-checkout.js" data-preference-id="<?php echo $preference->id; ?>" data-button-label="Paga Con Mercado Pago">
                            </script>
